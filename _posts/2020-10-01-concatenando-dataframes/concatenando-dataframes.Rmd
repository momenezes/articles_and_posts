...
timeMGRJ4arqs <- system.time({f1 <- read.dbc(paste0(diretorio,arquivos[1])); f2 <- read.dbc(paste0(diretorio,arquivos[2])); f3 <- read.dbc(paste0(diretorio,arquivos[3])); f4 <- read.dbc(paste0(diretorio,arquivos[4]));})
timeMGRJ4arqs
```
...
timeSP4arqs <- system.time({f1 <- read.dbc(paste0(diretorio,arquivos[1])); f2 <- read.dbc(paste0(diretorio,arquivos[2])); f3 <- read.dbc(paste0(diretorio,arquivos[3])); f4 <- read.dbc(paste0(diretorio,arquivos[4]));})
timeSP4arqs
```
